        ...
        <form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
            ...
            <div class="box fl-panel" id="login">
                ...
                <table class="table_form">
                    ...
                    <tr>
                        <td> <label for="code" class="fl-label">Login Code:</label> </td>
                        <td><form:input cssClass="required" cssErrorClass="error" id="code" size="25" tabindex="2" path="code" htmlEscape="true" autocomplete="off" /></td>
                    </tr>
